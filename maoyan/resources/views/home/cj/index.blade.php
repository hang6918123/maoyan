...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head> 
        ...
        <link rel="stylesheet" type="text/css" href="/home/cj/css/jq22.css" />
    ...
    <body>
        ...
        <div class="container">
          ...
          <h2 class="title">{{$cinema['cinema_name']}}</h2>
            ...
            <div class="demo clearfix">
                ...
                <div class="booking_area">
                    ...
                    <div style="width:300px"> <img src="/upload/videos/{{$video['photo']}}" style="width:250px;height:200px"> </div>
                    <p>电影：<span>{{$video['name']}}</span></p>

                    <p>时间：<span>{{$video['years']}} {{$movie['movies_common_time']?$movie['movies_common_time']:$movie['movies_special_time']}}</span></p>
        ...
        <script src="/home/cj/jquery-3.2.1.min.js"></script>

        <script type="text/javascript" src="/home/cj/jquery.seat-charts.min.js"></script>

        <script type="text/javascript">

            var price = {{$video['money']}}; //电影票价
        ...
        <script type="text/javascript">
            $('input[value=确定购买]').click(function() {
                var sel = $('.selected');
                var map_arr = [];
                sel.each(function() {
