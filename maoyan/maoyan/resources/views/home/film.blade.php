    ...
    <div class="movie-stats-container">
        ...
        <div class="movie-index">
          ...
          <div class="movie-index-content score normal-score">
              <span class="index-left info-num ">
                <span class="stonefont">{{$video['score']}}</span>
              </span>
              <div class="index-right">
                <div class='star-wrapper'>
                  <div class="star-on" style="width:95%;"></div>
                </div>
                 <span class='score-num'><span class="stonefont">{{count($score)}}</span>人评分</span>
              </div>
          </div>
        </div>
        ...
        <div class="movie-index">
          ...
          <div class="movie-index-content box">
              <span class="stonefont">{{$video['box_office']}}</span><span class="unit">亿</span>
          </div>
        </div>
    </div>
...
<div class="main-content-container clearfix">
  ...
  <div class="module">
    ...
    <div class="mod-content">
                    <span class="dra">{{$video['content']}}</span>
...
<ul>
    <li class="comment-container " data-val="{commentid:139153177}">
      <div class="portrait-container">
        <div class="portrait">
          <img src="/home/picture/7dd82a16316ab32c8359debdb04396ef2897.png@100w_100h_1e_1c" alt="">
        </div>
      ...
      <div class="main">
        <div class="main-header clearfix">
          <div class="user">
            <span class="name">Yuz897535946</span>
            
              <span class='tag'>购</span>
          </div>
          <div class="time" title="2018-02-16 10:49:11">
            <span title="2018-02-16 10:49:11">02-16</span>
...
<i class="half-star left active"></i><i class="half-star right active"></i>    </li>
          ...
          <div class="approve " data-id="139153177">
            <i data-act="comment-approve-click" class="approve-icon"></i><span class="num">12245</span>
          </div>
        </div>
        <div class="comment-content">比战狼好看，非常震撼，特效也是国产电影里佼佼者了</div>
      </div>
    </li>
  ...
  <dd class="news-item" data-act="new-click" data-val="{newsid:35226}">
    <div class="news-img">
      <a href="/films/news/35226" target="_blank">
        <img class="news-img-default" src="/home/picture/loading_2.e3d934bf.png" />
        <img class="news-img-detail" data-src="/home/picture/941a73dfdac13ea0f474436c814f751f242823.jpg@140w_86h_1e_1c" />
      </a>
    </div>
    <div class="news-main">
      <div class="news-title">
        <a href="/films/news/35226" target="_blank">《红海行动》荣登春节档票房冠军，营救侨民删减片段展大国实力</a>
      </div>
      <div class="news-info">
        <span class="news-source">猫眼电影</span><!--
        --><span><i class="news-icon news-icon-views"></i>7548</span><!--
  ...
  <dd>
    <div class="movie-item">
      ...
      <div class="movie-poster">
        ...
        <img data-src="/home/picture/1e0ac50e199ddde0dee9d824e95935881176431.jpg@106w_145h_1e_1c" />
      </div>
      </a>
